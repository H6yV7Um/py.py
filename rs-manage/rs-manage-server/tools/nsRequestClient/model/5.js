...
const REQ_MODEL_NAME = 'rs.WebpCompressRequest';
const RES_MODEL_NAME = 'rs.WebpCompressResponse';

module.exports = class MethodModel5 extends Base {
    constructor() {
        super(
            5,
            REQ_MODEL_NAME,
