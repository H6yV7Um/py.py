...
oojs.define({
    ...
    flashIETemplate: '<object classid="clsid:D27CDB6E-AE6D-11CF-96B8-444553540000" id="{{flashid}}"'
                            ...
                            + ' border="0" width="{{width}}" height="{{height}}" data="{{url}}">'
                     ...
                     + '</object>',
    flashNormalTemplate: '<embed pluginspage="//www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash"'
