/**
 * @file tuwen_image_text_fulllunbo_bc_raf template page event
 *@author nieyuxin
 */
    ...
    $page: function () {
        try {
            ...
            this.bind(window, 'resize', function () {
                ...
                rs.template.tuwen_image_text_fulllunbo_bc_raf.page.containerResize();
               // }, 100);
            });
        } catch (e) {
        }
    ...
    bindCloseHandler: function () {
        ...
        // for (var i = 0; i < liArray.length; i++) {
            ...
            this.bind(closeBtn, 'click', function () {
                rs.template.tuwen_image_text_fulllunbo_bc_raf.page.sdk.onAdPlayEnd();
                lunbo.stop();
                rs.template.tuwen_image_text_fulllunbo_bc_raf.page.stopEvent(this);
            });
        // }
