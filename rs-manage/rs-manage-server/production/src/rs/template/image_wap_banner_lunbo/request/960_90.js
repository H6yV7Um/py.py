oojs.define({
    name: '300_250',
    namespace: 'rs.template.image_wap_banner_lunbo.request',
    account: 'qiushi',
    searchId: null,
    styleConfig: null,
    ...
    adElements:[{
        ...
        height: 250,
        smartIdeaProduct: [],
		extention: '{"appinfo":{"rank":80,"size": 87,"name":"xxxxπŸ∑Ω∞Ê","appDesc":"xxxxΩÈ…‹","deteConf": {"timeInterval":1000000, "checkCount":5, "expiredTime":3600000000,"maxDetectTimes":5},"appData": {"appkey":"appkey","sk":"sk"}}}'
