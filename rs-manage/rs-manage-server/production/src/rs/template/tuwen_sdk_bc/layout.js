...
oojs.define({
    name: 'layout',
    namespace: 'rs.template.tuwen_sdk_bc',
    deps: {
    ...
    render: function (context) {
        ...
        var ItemBackground = userConfig['containerBackgroundColor'] || '3a99fe';
        var bc = '#' + ItemBackground;
        // container居中
        ...
        style['.item'] = {
            ...
            'height': itemHeight,
            'position': 'relative',
            'background': 'url({{dupDomain}}/cpro/ui/noexpire/img/2.0.3/rs_img/tuwen_sdk_bc.png) no-repeat',
        ...
        var titleFontSize =  Math.round(16 * pt);
        ...
        style['.item .title span'] = {
            font: 'normal bold ' + titleFontSize + 'px/' + Math.round(24 * pt) + 'px ' + titleFontFamily,
            color: '#' + titleFontColor
        };
        ...
        var descFontFamily = fullConfig.titleFontFamily || 'SimHei,arial,sans-serif;';
        var descFontColor = userConfig.descFontColor || '747474';
        ...
        style['.item .btn'] = {
            ...
            'height': btnHeight,
            'border-radius': Math.floor(15 * px) + 'px',
            'box-shadow': '1px 1px ' + Math.floor(px) + 'px ' + bc,
