/**
 * @file tuwen_wap_feed_banner_4 template layout
 * @author nieyuxin
 */
 /* global oojs */
...
oojs.define({
    name: 'layout',
    namespace: 'rs.template.tuwen_wap_feed_banner_4',
    deps: {
    ...
    render: function (context) {
        ...
        if (styleConfigObj && styleConfigObj.logoPaddingLeft) {
            titlePR = styleConfigObj.logoPaddingLeft * pt;
        }
