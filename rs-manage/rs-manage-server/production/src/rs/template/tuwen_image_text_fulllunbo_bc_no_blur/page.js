/**
 * @file tuwen_image_text_fulllunbo_bc_no_blur template page event
 *@author nieyuxin
 */
...
oojs.define({
    ...
    $page: function () {
        try {
            ...
            this.bind(window, 'resize', function () {
                ...
                rs.template.tuwen_image_text_fulllunbo_bc_no_blur.page.containerResize();
               // }, 100);
            });
        } catch (e) {
        }
    ...
    bindCloseHandler: function () {
        ...
        // for (var i = 0; i < liArray.length; i++) {
            ...
            this.bind(closeBtn, 'click', function () {
                rs.template.tuwen_image_text_fulllunbo_bc_no_blur.page.sdk.onAdPlayEnd();
                lunbo.stop();
                rs.template.tuwen_image_text_fulllunbo_bc_no_blur.page.stopEvent(this);
            });
        // }
    ...
    containerResize: function (event) {
        if (window.innerHeight > 0) {
            ...
            setTimeout(function () {rs.template.tuwen_image_text_fulllunbo_bc_no_blur.page.containerResize();}, 50);
        }
    },
