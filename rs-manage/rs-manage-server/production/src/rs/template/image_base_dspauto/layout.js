/**
 * @file image_base_dspauto template layout
 */
/* globals oojs */
        ...
        try {
            if (fullConfig.isShowCloseFeedBack) {
                ...
                for (var i = 0; i < mobileStr.length; i++) {
                    if (context.requestInfo.userAgent && context.requestInfo.userAgent && context.requestInfo.userAgent.toLowerCase().indexOf(
