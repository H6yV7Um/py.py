...
oojs.define({
    ...
    onAdClick: function (event) {
        ...
        var clickLogSrc = 'https://eclick.baidu.com/se.jpg?exp=70533&act=' + act + '&stamp=' + stamp + '&templateName=tuwen_sdk_banner_lunbo';
        ...
        var admcurl = this.getAttr(sourceElement, 'mcurl-val');
        // 因二次点击下载，修改act的值
        if (admcurl && admcurl !== 'null' && act === 2) {
            if (getId === 'item0') {
                adInfo.act = 1;
            };
            if (getId === 'item_btn_0') {
        ...
        // 排查问题添加的临时日志
        var clickLogSrc2 = 'https://eclick.baidu.com/se.jpg?exp=77533&act=' + act + '&stamp=' + stamp + '&templateName=tuwen_sdk_banner_lunbo';
