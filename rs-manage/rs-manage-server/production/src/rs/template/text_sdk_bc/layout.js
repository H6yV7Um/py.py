...
oojs.define({
    name: 'layout',
    namespace: 'rs.template.text_sdk_bc',
    deps: {
    ...
    render: function (context) {
        ...
        var ItemBackground = userConfig['containerBackgroundColor'] || '3a99fe';// adStyle.adBg;
        ...
        style['.item'] = {
            ...
            'position': 'relative',
            'background': 'url({{dupDomain}}/cpro/ui/noexpire/img/2.0.3/rs_img/text_sdk_bc.png) no-repeat',
        ...
        style['.item .title'] = {
            'width': textWidth,
            'margin-top': Math.round(5 * pt) * 2,
            'height': Math.round(34 * pt) * 2,
            'text-align': 'center'
        };
        ...
        style['.item .title span'] = {
            font: 'normal bold ' + titleFontSize + 'px/' + Math.round(34 * pt) + 'px ' + titleFontFamily,
        ...
        style['.item .btn'] = {
            ...
            'box-shadow': '2px 2px ' + Math.floor(px * 2) + 'px ' + bc,
            'background': bc
        };
        style['.item .btn img'] = {
