...
/**
 * @file image_sdk_banner_base_test
 * @author fanwenjuan
 */
/* eslint-disable max-len */
oojs.define({
    name: 'page',
    namespace: 'rs.template.image_sdk_banner_base_test',
    deps: {},
    //  Sdk js 接口
    sdk: {},
    // 轮播暂停 接口
    ...
    onAdClick: function (event) {
        ...
        if (admcurl && admcurl !== 'null') {
            if (adType === 2) {
                ...
                // 因为二次点击下载，左右两边的act值不一样，右边act修改为2
                if (getId === 'item_btn_0') {
                    adInfo.act = 2;
                }
            }
    ...
    changeStyle: function () {
        ...
        var bdIcon = document.getElementById('mob-bd-adIcon0');
