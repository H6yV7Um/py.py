oojs.define({
    name: '960_90_ie8',
    namespace: 'rs.template.flash_google_adx.request',
    account: "super-nova",
    searchId: null,
    styleConfig: null,
    userAgentType: "ie8",
    ...
    adElements: [{
        ...
        showUrl: '',
        stuffType: 200,
        stuffSrc: "http://ubmcmm.baidustatic.com/media/v1/0f000Qh_C34aM4bHsNY-Gs.swf?url_type=1&snapshot=&",
        width: 960,
        height: 90,
        smartIdeaProduct: [],
        extention: '{"snap":"http://ubmcmm.baidustatic.com/media/v1/0f000FI7hGpdyAmX3sJqp6.jpg"}'
    }]
});