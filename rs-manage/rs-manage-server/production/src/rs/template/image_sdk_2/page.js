...
oojs.define({
    ...
    containerResize: function () {
        if (window.innerHeight > 0) {
            ...
            var isIphone = userAgent.toLowerCase().indexOf('iphone') > -1 || userAgent.toLowerCase().indexOf('ipad') > -1;
            if (isIphone) {
                conH = conH - 20;
            }
            ...
            bdLogo.style.bottom = '0px';
        }
        else {
            this.resizeTimer = setTimeout(function () {
                rs.template.image_sdk_2.page.containerResize();
            }, 50);
        }
    },
    // 绑定下载按钮事件
