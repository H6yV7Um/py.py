oojs.define({
    ...
    + '</object>',
    flashNormalTemplate: '<embed pluginspage="//www.macromedia.com/go/getflashplayer"'
    ...
    getFlashHtml: function (option) {
        ...
        var flashTemplate = (option.browser && option.browser.type === 'ie' && option.browser.version < 9)
            ? this.flashIETemplate
            : this.flashNormalTemplate;
