oojs.define({
    ...
    writeNsHead: function (option) {
		...
		var methodId = parseInt(typeof option.methodId !== 'undefined' ? option.methodId : 0);
    ...
    /**
     * 长连接中nsHead多包的处理
     * {object} option  参数mapping对象
     * {object} option.data 网络包buffer对象
     * {object} option.socket  当前的socket对象
     * {object} option.processFunction  处理一次请求包的处理函数
     */
    multiPackageProcess: function (option) {
