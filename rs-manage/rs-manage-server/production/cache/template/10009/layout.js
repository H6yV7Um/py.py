...
oojs.define({
    ...
    render: function (requestInfo) {
        ...
        descText.innerHTML = ad.text.material.creativeDesc1 + ad.text.material.creativeDesc2;
        a.title = ad.text.action.forward.targetPage || '';
        a.href = ad.text.action.forward.clickLink.clickLink;
    ...
    calculate20T3: function (containerWidth, containerHeight) {
        ...
        // 广告位比例20.3时组件尺寸
        var result = {
            itemWidth: containerWidth - Math.round(18 * px),
