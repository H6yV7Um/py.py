...
oojs.define({
    ...
    render: function (requestInfo) {
        ...
        style['.item .dow'] = {
            ...
            + ' url({{dupDomain}}/cpro/ui/noexpire/img/appDownload/download.png) no-repeat top center',
        ...
        userConfig['appDownloadFontFamily'] && (dowFontFamily = userConfig['appDownloadFontFamily']
            + ',' + dowFontFamily);
        style['.item .dow span'] = {
            'position': 'absolute',
            'text-align': 'center',
