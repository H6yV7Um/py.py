...
oojs.define({
    ...
    render: function (requestInfo) {
        ...
        var verticalMargin = (containerHeight - screenHeight - marginTitlePicture - (titleFontSize + 4) * 2) / 2;
        paddingTitleTop = paddingTitleTop === 0 ? verticalMargin : paddingTitleTop;
        style['.item'] = {
            width: '100%',
            height: '100%'
        };
        ...
        style['.desc'] = {
            ...
            'margin-left': marginDescriptionPicture + 'px',
            'overflow': 'hidden',
            'text-overflow': 'ellipsis',
            'display': '-webkit-box',
            '-webkit-line-clamp': 2,
        ...
        style['.text'] = {
            'float': 'left',
            'width': (containerWidth - paddingLeft - paddingRight - marginDescriptionPicture - screenWidth) + 'px',
            'margin-top': (marginTitleDescription - marginTitlePicture) + 'px',
            'height': screenHeight + 'px',
            'overflow': 'hidden'
        };
        style['.item a'] = {
