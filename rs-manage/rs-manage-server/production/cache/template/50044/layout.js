...
oojs.define({
    ...
    render: function (requestInfo) {
        ...
        marginTitlePicture = (marginTitlePicture === null || marginTitlePicture === undefined) ? 10
        : marginTitlePicture;
        ...
        var imgRatio = parseInt(screenWidth, 10) / parseInt(screenHeight, 10);
        ...
        var titleMarginLeft = (parseInt(pdp, 10) === 1) ? marginTitlePicture : 0;
        var titleMarginRight = (parseInt(pdp, 10) === 3) ? marginTitlePicture : 0;
        var imgPos = parseInt(pdp, 10) === 1 ? 'left' : 'right';
