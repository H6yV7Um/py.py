...
var ads = {
    mainCreatives: [{
        ...
        text: {
            material: {
                creativeName: 'text_material',
                creativeTitle: 'Hello World2',
                creativeDesc1: 'create desc 2',
                creativeDesc2: 'create desc 3'
            },
            action: {
                actionType: 4,
                actionTypeMessageName: 'forward',
        ...
        text: {
            material: {
                creativeName: 'text_material',
                creativeTitle: 'Hello World3',
                creativeDesc1: 'create desc 3',
                creativeDesc2: 'create desc 4'
            },
            action: {
                actionType: 4,
                actionTypeMessageName: 'forward',
