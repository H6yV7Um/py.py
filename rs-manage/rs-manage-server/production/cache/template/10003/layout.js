...
oojs.define({
    ...
    render: function (requestInfo) {
        ...
        var adLength = ads.mainCreatives.length;
        var style = {};
        ...
        for (var i = 0; i < rowCount; i++) {
            for (var j = 0; j < columnCount; j++) {
                ...
                if (adLength > adIndex) {
                    ...
                    item.class = 'item';
                    var clickLink = '';
                    if (ad.text.action.forward.clickLink) {
                        clickLink = ad.text.action.forward.clickLink.clickLink;
                    }
                    if (fullConfig.titleIsShow) {
                        ...
                        a.target = 'blank';
                        a.id = 'title_' + adIndex;
                        a.title = ad.text.action.forward.targetPage || '';
                        a.href = clickLink;
                        a.innerHTML = ad.text.material.creativeTitle;
                    ...
                    if (fullConfig.descIsShow) {
                        ...
                        a.title = ad.text.action.forward.targetPage || '';
                        a.href = clickLink;
                        a.innerHTML = ad.text.material.creativeDesc1 + '&nbsp' + ad.text.material.creativeDesc2;
        ...
        var lastAd = ads.mainCreatives[lastIndex].text.material;
        if (count <= adLength && (lastAd.creativeDesc1 + ' ' + lastAd.creativeDesc2).length * descStyle['font-size'] >= descStyle['width'] * Math.floor(lastDescDivHeight / descStyle['line-height'])) {
