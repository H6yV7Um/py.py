...
oojs.define({
    ...
    render: function (requestInfo) {
        ...
        var adconHeight = itemHeight;
        var logHeight = itemHeight;
        ...
        // 翻页动画
        style['#container .item .adcon .turning']
        = {'animation': 'turning 21s linear 7s infinite',
        '-moz-animation': 'turning 21s linear 7s infinite',
        '-webkit-animation': 'turning 21s linear 7s infinite',
        '-o-animation': 'turning 21s linear 7s infinite'};
